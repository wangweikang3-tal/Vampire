...
public class GlobalPlayerAttribute 
{
   ...
   //总属性
   public static int TotalMaxHp=0;
   public static int TotalDamage=0;
   public static int TotalMoveSpeed=0;
   public static int TotalAttackSpeed=0;
   public static int TotalCRIT=0;
   public static int TotalCRITDamage=0;
   public static int TotalBloodSuck=0;
   public static int TotalDenfense=0;
   public static int TotalGoodFortune=0;
}
